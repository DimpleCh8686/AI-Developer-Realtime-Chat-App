        ...
        <section className='left relative flex flex-col h-full min-w-96 bg-slate-300'>
            ...
            <div className="conversation-area flex-grow flex flex-col">
              ...
              <div className="inputField w-full flex">
                <input 
                className='p-2 px-6 border-none outline-none flex-grow'
                type="text"
          ...
          <div className={`sidePanel w-full h-full flex flex-col gap-2 bg-slate-100 absolute transition-all ${ isSidePanelOpen?'translate-x-0': '-translate-x-full' } top-0`}>
            <header
            className='flex justify-between items-center px-4 p-2 bg-slate-400'>
              <h1
